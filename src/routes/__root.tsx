  ...
  head: () => ({
    meta: [
      ...
      { title: BUSINESS_NAME },
      {
        name: "description",
        content:
          "Herramientas profesionales de terapia oral y motora para la alimentación, el desarrollo del habla y la estimulación sensorial.",
      },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          name: BUSINESS_NAME,
          description:
            "Venta y asesoría de herramientas profesionales de terapia oral y motora TalkTools® y ARK Therapeutic.",
        }),
      },
    ],
  }),
